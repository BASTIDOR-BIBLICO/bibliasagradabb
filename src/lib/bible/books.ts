...
export const BOOKS: BibleBook[] = [
  ...
  { id: "exodo", name: "Êxodo", abbrev: "Êx", testament: "AT", chapters: 40 },
  ...
  { id: "cantares", name: "Cantares", abbrev: "Ct", testament: "AT", chapters: 8 },
  ...
  { id: "oseias", name: "Oséias", abbrev: "Os", testament: "AT", chapters: 14 },
...
export const oldTestament = BOOKS.filter((b) => b.testament === "AT");
export const newTestament = BOOKS.filter((b) => b.testament === "NT");
